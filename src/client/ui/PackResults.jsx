        ...
        return (
            <div className="results-view border-color-gray">
                ...
                <div className="results-view-wrapper">
                    ...
                    <div ref={this.wheelRef} className="results-view-container panel-surface" onClick={this.clearSelection}>
                    ...
                    <div className="results-view-footer panel-surface border-color-gray">
